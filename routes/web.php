...
Route::view('development-solutions', 'front.developmentsolutions')->name('developmentsolutions');
...
Route::view('enterprise-solutions', 'front.enterprisesolutions')->name('enterprisesolutions');
