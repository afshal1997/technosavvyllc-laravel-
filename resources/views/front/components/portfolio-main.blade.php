		...
		<div class="menu-box">
			<ul class="tab-links-ntn">
				...
				<li>
					<a class="tab-link-ntn 
						<?php if ($port_page == 'web-development-portfolio') {
							echo 'active';
						} ?>" href="javascript:void(0)" data-id="tab-ntn-2">
							Web Development
					</a>
				</li>
				<li>
				...
				<?php if ($port_page == 'app-development-portfolio') {
					echo 'active';
				} ?>" href="javascript:void(0)" data-id="tab-ntn-3">
						App Development
					</a>
				</li>
				<li>
					<a class="tab-link-ntn 
						<?php if ($port_page == 'brand-creative-portfolio') {
							echo 'active';
						} ?>" href="javascript:void(0)" data-id="tab-ntn-4">
						Brand And Creative
					</a>
				</li>
				<?php if ($port_page == 'animations-portfolio') {
					echo 'active';
				} ?>
			</ul>
		</div>
